...
<svg viewBox="0 0 960 560" xmlns="http://www.w3.org/2000/svg"
  ...
  <path d="M190,230 C350,140 370,110 339,90"
  ...
  <path d="M190,230 C330,235 350,230 370,240"
